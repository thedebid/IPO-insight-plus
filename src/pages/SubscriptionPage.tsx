...
import { Crown, Check, Mail, MessageSquare, Globe, Flag } from "lucide-react";
  ...
  const [features, setFeatures] = useState<SubscriptionFeature[]>([
    {
      ...
      name: "Email Alerts",
      description:
        "Receive detailed email notifications for IPO updates and announcements",
      price: 9.99,
    ...
    },
    {
      ...
      name: "SMS Alerts",
      description:
        "Get instant SMS notifications for time-sensitive IPO opportunities",
      price: 14.99,
    ...
    },
    {
      ...
      description:
        "Track domestic IPOs with detailed market analysis and insights",
      price: 19.99,
    ...
    },
    {
      ...
      description:
        "Access international IPO markets and global investment opportunities",
      price: 24.99,
  ...
  const handleSaveSubscription = async () => {
    ...
    try {
      const subscriptionData = {
        emailNotifications:
          features.find((f) => f.id === "email_alerts")?.enabled || false,
        smsAlerts:
          features.find((f) => f.id === "sms_alerts")?.enabled || false,
        localIpoAccess:
          features.find((f) => f.id === "local_ipo")?.enabled || false,
        foreignIpoAccess:
          features.find((f) => f.id === "foreign_ipo")?.enabled || false,
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-lg lg:rounded-xl shadow-sm border p-4 lg:p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {predefinedPlans.map((plan) => (
                  <div
                    key={plan.id}
                    className="border border-gray-200 rounded-lg p-3 lg:p-4 hover:border-blue-300 transition-colors"
                  >
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg lg:rounded-xl p-4 lg:p-6">
              <h4 className="text-sm lg:text-base font-semibold text-emerald-800 mb-2">
                💡 Smart Savings
              </h4>
              <p className="text-emerald-700 text-xs lg:text-sm mb-3">
                Bundle features together to save money with our predefined plans
                above.
              </p>
              {calculateTotal() > 50 && (
                <div className="bg-emerald-100 border border-emerald-300 rounded-lg p-2 lg:p-3">
                  <p className="text-emerald-800 text-xs font-medium">
                    🎉 You qualify for enterprise pricing! Contact sales for
                    better rates.
                  </p>
                </div>
              )}
            ...
            {/* Feature Benefits */}
            <div className="bg-white rounded-lg lg:rounded-xl shadow-sm border p-4 lg:p-6">
              <h4 className="text-sm lg:text-base font-semibold text-gray-900 mb-4">
              ...
              <div className="space-y-2 lg:space-y-3 text-xs lg:text-sm">
                <div className="flex items-start">
                  ...
                  <span className="text-gray-600">
                    Real-time notifications ensure you never miss opportunities
                  </span>
                </div>
                <div className="flex items-start">
                  <Check className="h-3 w-3 lg:h-4 lg:w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    SMS alerts provide instant mobile updates
                  </span>
                </div>
                <div className="flex items-start">
                  <Check className="h-3 w-3 lg:h-4 lg:w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Global market access opens more investment opportunities
                  </span>
                </div>
              </div>
            </div>
